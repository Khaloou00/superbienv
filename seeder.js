...
const FILMS_DATA = [
...

  {
    ...
    synopsis: 'Paul Atréides s\'unit aux Fremen pour mener une guerre sainte contre les maîtres de l\'épice. Condamné à choisir entre l\'amour de Chani et le destin de l\'univers connu, il accomplit une prophétie aux conséquences dévastatrices.',
    genre: 'Action',
    type: 'Film',
    duree: 166,
    realisateur: 'Denis Villeneuve',
    casting: ['Timothée Chalamet', 'Zendaya', 'Austin Butler', 'Rebecca Ferguson'],
    note: 8.5,
    langue: 'VF',
    age: '12+',
    badge: 'NOUVEAU',
    ...
    seances: [
      { date: d(0),  heure: '19:30', placesTotal: 80, placesDisponibles: 38, placesVIP: 10, placesVIPDisponibles: 4 },
      { date: d(2),  heure: '20:00', placesTotal: 80, placesDisponibles: 65, placesVIP: 10, placesVIPDisponibles: 8 },
      { date: d(5),  heure: '21:00', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    ...
    synopsis: 'Wade Wilson reprend le costume de Deadpool et rejoint le multivers Marvel avec un Wolverine peu enthousiaste. Ensemble, ils doivent sauver leur univers dans une aventure explosive, drôle et complètement déjantée.',
    genre: 'Action',
    type: 'Film',
    duree: 128,
    realisateur: 'Shawn Levy',
    casting: ['Ryan Reynolds', 'Hugh Jackman', 'Emma Corrin', 'Jennifer Garner'],
    note: 8.1,
    langue: 'VF',
    age: '16+',
    badge: 'NOUVEAU',
    ...
    seances: [
      { date: d(0),  heure: '21:30', placesTotal: 80, placesDisponibles: 20, placesVIP: 10, placesVIPDisponibles: 2 },
      { date: d(3),  heure: '20:30', placesTotal: 80, placesDisponibles: 55, placesVIP: 10, placesVIPDisponibles: 6 },
      { date: d(7),  heure: '22:00', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    titre: 'Vice-Versa 2',
    poster: 'https://images.unsplash.com/photo-1513151233558-d860c5398176?w=400&h=600&fit=crop&q=80',
    synopsis: 'Riley entre au lycée et ses émotions — Joie, Tristesse, Colère, Peur et Dégoût — doivent faire face à une nouvelle arrivante inattendue : Anxiété. Une aventure intérieure sur l\'adolescence et l\'identité.',
    genre: 'Animation',
    type: 'Film',
    duree: 100,
    realisateur: 'Kelsey Mann',
    casting: ['Amy Poehler', 'Maya Hawke', 'Kensington Tallman', 'Liza Lapira'],
    note: 7.9,
    langue: 'VF',
    age: 'Tout public',
    badge: '',
    ...
    seances: [
      { date: d(1),  heure: '17:00', placesTotal: 80, placesDisponibles: 42, placesVIP: 10, placesVIPDisponibles: 5 },
      { date: d(4),  heure: '17:30', placesTotal: 80, placesDisponibles: 70, placesVIP: 10, placesVIPDisponibles: 9 },
      { date: d(8),  heure: '18:00', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    titre: 'Avengers: Secret Wars',
    poster: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=600&fit=crop&q=80',
    synopsis: 'Le multivers s\'effondre. Les Avengers de toutes les réalités s\'unissent pour affronter la menace ultime dans un affrontement épique qui redéfinira l\'univers Marvel pour toujours.',
    genre: 'Action',
    type: 'Film',
    duree: 150,
    realisateur: 'Joe Russo',
    casting: ['Robert Downey Jr.', 'Chris Evans', 'Scarlett Johansson', 'Tom Holland'],
    note: 9.0,
    langue: 'VF',
    age: 'Tout public',
    badge: 'NOUVEAU',
    seances: [
      { date: d(2),  heure: '20:00', placesTotal: 80, placesDisponibles: 10, placesVIP: 10, placesVIPDisponibles: 1 },
      { date: d(4),  heure: '21:00', placesTotal: 80, placesDisponibles: 45, placesVIP: 10, placesVIPDisponibles: 5 },
      { date: d(9),  heure: '20:30', placesTotal: 80, placesDisponibles: 78, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    ...
    synopsis: 'Vaiana reçoit un appel inattendu de ses ancêtres et s\'embarque dans une nouvelle aventure à travers les vastes océans polynésiens pour trouver un peuple perdu depuis des générations.',
    genre: 'Animation',
    type: 'Film',
    duree: 100,
    realisateur: 'David G. Derrick Jr.',
    casting: ['Auli\'i Cravalho', 'Dwayne Johnson', 'Alan Tudyk'],
    note: 7.2,
    langue: 'VF',
    age: 'Tout public',
    badge: '',
    trailerUrl: 'https://www.youtube.com/watch?v=K2favFFKxFg',
    seances: [
      { date: d(1),  heure: '16:30', placesTotal: 80, placesDisponibles: 60, placesVIP: 10, placesVIPDisponibles: 8 },
      { date: d(6),  heure: '17:00', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    titre: 'Gladiateur II',
    poster: 'https://images.unsplash.com/photo-1499002238440-d264edd596ec?w=400&h=600&fit=crop&q=80',
    synopsis: 'Des années après la mort de Maximus, Lucius — fils de Lucilla — est capturé et contraint de combattre dans les arènes de Rome. Pour survivre, il devra embrasser le destin d\'un gladiateur dans un empire en plein chaos.',
    genre: 'Action',
    type: 'Film',
    duree: 148,
    realisateur: 'Ridley Scott',
    casting: ['Paul Mescal', 'Pedro Pascal', 'Denzel Washington', 'Connie Nielsen'],
    note: 7.5,
    langue: 'VF',
    age: '16+',
    badge: 'NOUVEAU',
    trailerUrl: 'https://www.youtube.com/watch?v=Bnm_8Z0MPxE',
    seances: [
      { date: d(0),  heure: '20:30', placesTotal: 80, placesDisponibles: 48, placesVIP: 10, placesVIPDisponibles: 6 },
      { date: d(3),  heure: '21:00', placesTotal: 80, placesDisponibles: 72, placesVIP: 10, placesVIPDisponibles: 9 },
      { date: d(7),  heure: '20:00', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    ...
    synopsis: 'L\'histoire jamais racontée des sorcières d\'Oz : comment Glinda la Bonne et Elphaba — future Méchante Sorcière de l\'Ouest — sont passées de meilleures amies à ennemies jurées.',
    genre: 'Comédie',
    type: 'Film',
    duree: 160,
    realisateur: 'Jon M. Chu',
    casting: ['Cynthia Erivo', 'Ariana Grande', 'Jeff Goldblum', 'Jonathan Bailey'],
    note: 8.0,
    langue: 'VF',
    age: 'Tout public',
    badge: 'NOUVEAU',
    ...
    seances: [
      { date: d(1),  heure: '19:00', placesTotal: 80, placesDisponibles: 35, placesVIP: 10, placesVIPDisponibles: 4 },
      { date: d(5),  heure: '19:30', placesTotal: 80, placesDisponibles: 68, placesVIP: 10, placesVIPDisponibles: 8 },
      { date: d(10), heure: '20:00', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    titre: 'Alien: Romulus',
    poster: 'https://images.unsplash.com/photo-1462331940025-496dfbfc7564?w=400&h=600&fit=crop&q=80',
    synopsis: 'Un groupe de jeunes colonisateurs explore une station spatiale abandonnée et se retrouve face à la forme de vie la plus terrifiante de l\'univers. Une nouvelle descente en enfer dans la saga Alien.',
    genre: 'Horreur',
    type: 'Film',
    duree: 119,
    realisateur: 'Fede Álvarez',
    casting: ['Cailee Spaeny', 'David Jonsson', 'Archie Renaux', 'Isabela Merced'],
    note: 7.3,
    langue: 'VOST',
    age: '16+',
    badge: '',
    trailerUrl: 'https://www.youtube.com/watch?v=m_kzf1bYMFQ',
    seances: [
      { date: d(2),  heure: '22:30', placesTotal: 80, placesDisponibles: 55, placesVIP: 10, placesVIPDisponibles: 7 },
      { date: d(6),  heure: '23:00', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    ...
    synopsis: 'Miles Morales fait face à une menace qui transcende tous les univers. Dans cette conclusion épique, le destin du Spider-Verse dépend d\'un choix impossible entre sa famille et son identité de héros.',
    genre: 'Animation',
    type: 'Film',
    duree: 120,
    realisateur: 'Joaquim Dos Santos',
    casting: ['Shameik Moore', 'Hailee Steinfeld', 'Oscar Isaac', 'Issa Rae'],
    note: 9.2,
    langue: 'VF',
    age: 'Tout public',
    badge: 'NOUVEAU',
    seances: [
      { date: d(1),  heure: '18:00', placesTotal: 80, placesDisponibles: 8,  placesVIP: 10, placesVIPDisponibles: 1 },
      { date: d(3),  heure: '18:30', placesTotal: 80, placesDisponibles: 30, placesVIP: 10, placesVIPDisponibles: 3 },
      { date: d(8),  heure: '19:00', placesTotal: 80, placesDisponibles: 75, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    ...
    synopsis: 'Ethan Hunt et son équipe affrontent leur mission la plus périlleuse : empêcher une intelligence artificielle toute-puissante de déclencher une guerre mondiale. La conclusion ultime d\'une saga légendaire.',
    genre: 'Action',
    type: 'Film',
    duree: 169,
    realisateur: 'Christopher McQuarrie',
    casting: ['Tom Cruise', 'Hayley Atwell', 'Ving Rhames', 'Simon Pegg'],
    note: 8.2,
    langue: 'VF',
    age: '12+',
    badge: 'NOUVEAU',
    trailerUrl: 'https://www.youtube.com/watch?v=avz06PDqgxE',
    seances: [
      { date: d(0),  heure: '20:00', placesTotal: 80, placesDisponibles: 25, placesVIP: 10, placesVIPDisponibles: 3 },
      { date: d(4),  heure: '20:30', placesTotal: 80, placesDisponibles: 60, placesVIP: 10, placesVIPDisponibles: 7 },
      { date: d(9),  heure: '21:00', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  // ─── CINÉMA AFRICAIN & IVOIRIEN ──────────────────────────────────────────────

  {
    titre: 'Les Misérables d\'Abidjan',
    poster: 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=400&h=600&fit=crop&q=80',
    synopsis: 'Dans les quartiers populaires d\'Abidjan, trois policiers patrouillent dans une cité en ébullition. Quand un incident mineur déclenche une crise qui embrase le quartier, chacun devra choisir son camp.',
    genre: 'Drame',
    type: 'Film',
    duree: 104,
    realisateur: 'Isaak Yapo',
    casting: ['Franck Sy', 'Evelyne Kéké', 'Adama Coulibaly', 'Mariam Ouattara'],
    note: 8.8,
    langue: 'VF',
    age: '12+',
    badge: 'NOUVEAU',
    seances: [
      { date: d(0),  heure: '18:30', placesTotal: 80, placesDisponibles: 44, placesVIP: 10, placesVIPDisponibles: 6 },
      { date: d(3),  heure: '19:00', placesTotal: 80, placesDisponibles: 70, placesVIP: 10, placesVIPDisponibles: 9 },
      { date: d(7),  heure: '19:30', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    titre: 'African Queens: Njinga',
    poster: 'https://images.unsplash.com/photo-1578301978018-3005759f48f7?w=400&h=600&fit=crop&q=80',
    synopsis: 'Le destin extraordinaire de la reine Njinga d\'Angola, guerrière et diplomate du XVIIᵉ siècle qui résista à la colonisation portugaise avec une intelligence et une ténacité sans pareilles. Un documentaire épique produit par Netflix Africa.',
    genre: 'Documentaire',
    type: 'Film',
    duree: 88,
    realisateur: 'Nadia Hallgren',
    casting: ['Tina Mba', 'Yvonne Chaka Chaka'],
    note: 8.0,
    langue: 'VF',
    age: 'Tout public',
    badge: '',
    seances: [
      { date: d(2),  heure: '18:00', placesTotal: 80, placesDisponibles: 62, placesVIP: 10, placesVIPDisponibles: 8 },
      { date: d(6),  heure: '18:30', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    titre: 'Mami Wata',
    poster: 'https://images.unsplash.com/photo-1502209524164-acea936639a2?w=400&h=600&fit=crop&q=80',
    synopsis: 'Dans un village côtier d\'Afrique de l\'Ouest, deux sœurs défendent l\'héritage spirituel de Mami Wata, déesse des eaux. Quand un étranger arrive avec des promesses de modernité, l\'âme du village est en jeu. Primé au Festival de Sundance 2023.',
    genre: 'Drame',
    type: 'Film',
    duree: 94,
    realisateur: 'C.J. "Fiery" Obasi',
    casting: ['Evelyne Ily Juhen', 'Uzoamaka Anionwu', 'Emeka Amakeze'],
    note: 7.8,
    langue: 'VOST',
    age: '12+',
    badge: 'NOUVEAU',
    seances: [
      { date: d(1),  heure: '20:00', placesTotal: 80, placesDisponibles: 58, placesVIP: 10, placesVIPDisponibles: 7 },
      { date: d(5),  heure: '20:30', placesTotal: 80, placesDisponibles: 78, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    titre: 'Sira',
    poster: 'https://images.unsplash.com/photo-1489493512598-d08130f49bea?w=400&h=600&fit=crop&q=80',
    synopsis: 'Au Sahel, Sira est enlevée par des djihadistes lors de son voyage de noces. Seule face à ses ravisseurs dans l\'immensité du désert, elle refuse de se soumettre et lutte pour sa survie avec une force insoupçonnée. Film burkinabè primé en Afrique.',
    genre: 'Action',
    type: 'Film',
    duree: 85,
    realisateur: 'Apolline Traoré',
    casting: ['Nafissatou Cissé', 'Abdoul Salam Sawadogo', 'Ibrahim Koma'],
    note: 8.1,
    langue: 'VF',
    age: '16+',
    badge: 'NOUVEAU',
    seances: [
      { date: d(2),  heure: '19:00', placesTotal: 80, placesDisponibles: 50, placesVIP: 10, placesVIPDisponibles: 6 },
      { date: d(5),  heure: '19:30', placesTotal: 80, placesDisponibles: 75, placesVIP: 10, placesVIPDisponibles: 9 },
      { date: d(8),  heure: '20:00', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },

  {
    titre: 'Sentiment ya ba',
    poster: 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=400&h=600&fit=crop&q=80',
    synopsis: 'À Treichville, Kouamé jongle entre sa petite amie jalouse, sa mère envahissante et son meilleur ami comédien. Une comédie romantique abidjanaise pleine de couleurs, de musique coupé-décalé et de situations hilarantes typiquement ivoiriennes.',
    genre: 'Comédie',
    type: 'Film',
    duree: 95,
    realisateur: 'Henri Duparc Jr.',
    casting: ['Serge Béhi', 'Akissi Delta', 'Didi B', 'Josey'],
    note: 7.6,
    langue: 'VF',
    age: 'Tout public',
    badge: '',
    seances: [
      { date: d(0),  heure: '17:30', placesTotal: 80, placesDisponibles: 52, placesVIP: 10, placesVIPDisponibles: 7 },
      { date: d(3),  heure: '18:00', placesTotal: 80, placesDisponibles: 68, placesVIP: 10, placesVIPDisponibles: 9 },
      { date: d(6),  heure: '18:30', placesTotal: 80, placesDisponibles: 80, placesVIP: 10, placesVIPDisponibles: 10 },
    ],
  },
];
